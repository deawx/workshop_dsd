...
<div class="panel panel-warning">
  ...
  <div class="panel-body">
    ...
    <div class="form-group">
      ...
      <div class="col-md-3">
        <?php $y = array(''=>'ปี พ.ศ.'); foreach (range('2500',(date('Y')+543)) as $value) $y[$value] = $value;
    ...
    <div class="form-group">
      <?=form_label('หมู่โลหิต','',array('class'=>'control-label col-md-4'));?>
    ...
    <div class="form-group">
      <?=form_label('วุฒิการศึกษา','',array('class'=>'control-label col-md-4'));?>
    ...
    <div class="form-group">
      <?=form_label('อาชีพ','',array('class'=>'control-label col-md-4'));?>
      <div class="col-md-8"> <?=form_input(array('name'=>'work[career]','class'=>'form-control'),set_value('work[career]',$work['career']));?> </div>
    </div>
    <div class="form-group">
      <?=form_label('สถานที่ทำงาน','',array('class'=>'control-label col-md-4'));?>
    ...
    <div class="form-group">
      <?=form_label('เอกสารหลักฐานประกอบการยื่นคำขอ','',array('class'=>'control-label col-md-4'));?>
      <div class="col-md-8">
