...
<div class="form-group">
  ...
  <div class="col-md-8">
    ...
    <?php echo form_input(array('name'=>'career[2]','class'=>'form-control','id'=>'career2','placeholder'=>'สาขาอาชีพ..'),set_value('career[2]'));?>
    <p class="help-block"></p>
    <?php echo form_input(array('name'=>'career[3]','class'=>'form-control','id'=>'career3','placeholder'=>'สาขาอาชีพ..'),set_value('career[3]'));?>
    <p class="help-block"></p>
    <?php echo form_input(array('name'=>'career[4]','class'=>'form-control','id'=>'career4','placeholder'=>'สาขาอาชีพ..'),set_value('career[4]'));?>
    <p class="help-block"></p>
    <?php echo form_input(array('name'=>'career[5]','class'=>'form-control','id'=>'career5','placeholder'=>'สาขาอาชีพ..'),set_value('career[5]'));?>
    <p class="help-block"></p>
  </div>
</div>
