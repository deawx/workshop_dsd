...
<div class="panel panel-warning">
  ...
  <div class="panel-body">
    ...
    <div class="form-group">
      ...
      <div class="col-md-8"> <?php echo form_input(array('name'=>'department','class'=>'form-control'),set_value('department',$standard['department']));?> </div>
    </div>
    <div class="form-group">
      <?php echo form_label('สาขาอาชีพ','branch',array('class'=>'control-label col-md-4'));?>
      <div class="col-md-8"> <?php echo form_input(array('name'=>'branch','class'=>'form-control'),set_value('branch',$standard['branch']));?> </div>
    </div>
    <div class="form-group">
      <?php echo form_label('ระดับ','level',array('class'=>'control-label col-md-4'));?>
      <div class="col-md-8"> <?php echo form_input(array('name'=>'level','class'=>'form-control'),set_value('level',$standard['level']));?> </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-md-8"> <?php echo form_input(array('name'=>'profile[firstname]','class'=>'form-control'),set_value('profile[firstname]',$profile['firstname']));?> </div>
    </div>
    <div class="form-group">
      <?php echo form_label('นามสกุล','',array('class'=>'control-label col-md-4'));?>
      <div class="col-md-8"> <?php echo form_input(array('name'=>'profile[lastname]','class'=>'form-control'),set_value('profile[lastname]',$profile['lastname']));?> </div>
    </div>
    <div class="form-group">
      <?php echo form_label('ชื่อเต็ม(ภาษาอังกฤษ)','',array('class'=>'control-label col-md-4'));?>
      <div class="col-md-8"> <?php echo form_input(array('name'=>'profile[fullname]','class'=>'form-control'),set_value('profile[fullname]',$profile['fullname']));?> </div>
    </div>
    <div class="form-group">
      <?php echo form_label('ศาสนา','',array('class'=>'control-label col-md-4'));?>
      <div class="col-md-8"> <?php echo form_input(array('name'=>'profile[religion]','class'=>'form-control'),set_value('profile[religion]',$profile['religion']));?> </div>
    </div>
    <div class="form-group">
      <?php echo form_label('สัญชาติ','',array('class'=>'control-label col-md-4'));?>
      <div class="col-md-8"> <?php echo form_input(array('name'=>'profile[nationality]','class'=>'form-control'),set_value('profile[nationality]',$profile['nationality']));?> </div>
    </div>
    <div class="form-group">
      <?php echo form_label('หมายเลขบัตรประชาชน','',array('class'=>'control-label col-md-4'));?>
      <div class="col-md-8"> <?php echo form_input(array('name'=>'profile[id_card]','class'=>'form-control','id'=>'id_card','disabled'=>TRUE),set_value('profile[id_card]',$profile['id_card']));?> </div>
    </div>
    <div class="form-group">
      ...
      <div class="col-md-2">
        ...
        echo form_dropdown(array('name'=>'d','class'=>'form-control'),$d,set_value('d',($user['birthdate']) ? date('d',($profile['birthdate'])) : NULL));?>
      </div>
      <div class="col-md-3"> <?php echo form_dropdown(array('name'=>'m','class'=>'form-control'),dropdown_month(),set_value('m',($user['birthdate']) ? date('m',$profile['birthdate']) : NULL));?> </div>
      <div class="col-md-3">
        <?php $y = array(''=>'ปี พ.ศ.');
        foreach (range('2500',(date('Y')+543)) as $value) $y[$value] = $value;
        echo form_dropdown(array('name'=>'y','class'=>'form-control'),$y,set_value('y',($user['birthdate']) ? date('Y',$profile['birthdate'])+543 : NULL));?>
      </div>
    </div>
    <div class="form-group">
      <?php echo form_label('ที่อยู่เลขที่(ปัจจุบัน)','',array('class'=>'control-label col-md-4'));?>
      <div class="col-md-8"> <?php echo form_input(array('name'=>'address[address]','class'=>'form-control'),set_value('address[address]',$address['address']));?> </div>
    </div>
    <div class="form-group">
      <?php echo form_label('ถนน','',array('class'=>'control-label col-md-4'));?>
      <div class="col-md-8"> <?php echo form_input(array('name'=>'address[street]','class'=>'form-control'),set_value('address[street]',$address['street']));?> </div>
    </div>
    <div class="form-group">
      <?php echo form_label('ตำบล','',array('class'=>'control-label col-md-4'));?>
      <div class="col-md-8"> <?php echo form_input(array('name'=>'address[tambon]','class'=>'form-control'),set_value('address[tambon]',$address['tambon']));?> </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-md-8"> <?php echo form_input(array('name'=>'address[province]','class'=>'form-control'),set_value('address[province]',$address['province']));?> </div>
    </div>
    <div class="form-group">
      <?php echo form_label('รหัสไปรษณีย์','',array('class'=>'control-label col-md-4'));?>
      <div class="col-md-8"> <?php echo form_input(array('name'=>'address[zip]','class'=>'form-control zip'),set_value('address[zip]',$address['zip']));?> </div>
    </div>
    <div class="form-group">
      <?php echo form_label('อีเมล์','email',array('class'=>'control-label col-md-4'));?>
      <div class="col-md-8"> <?php echo form_email(array('name'=>'address[email]','class'=>'form-control'),set_value('address[email]',$address['email']));?> </div>
    </div>
    <div class="form-group">
      <?php echo form_label('โทรศัพท์','phone',array('class'=>'control-label col-md-4'));?>
      <div class="col-md-8"> <?php echo form_input(array('name'=>'address[phone]','class'=>'form-control tel','max_length'=>'10'),set_value('address[phone]',$address['phone']));?> </div>
    </div>
    <div class="form-group">
      <?php echo form_label('โทรสาร','fax',array('class'=>'control-label col-md-4'));?>
      <div class="col-md-8"> <?php echo form_input(array('name'=>'address[fax]','class'=>'form-control tel','max_length'=>'10'),set_value('address[fax]',$address['fax']));?> </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-md-8"> <?php echo form_input(array('name'=>'education[branch]','class'=>'form-control'),set_value('education[branch]',$education['branch']));?> </div>
    </div>
    <div class="form-group">
      <?php echo form_label('สถานศึกษา','',array('class'=>'control-label col-md-4'));?>
      <div class="col-md-8"> <?php echo form_input(array('name'=>'education[place]','class'=>'form-control'),set_value('education[place]',$education['place']));?> </div>
    </div>
    <div class="form-group">
      <?php echo form_label('จังหวัด','',array('class'=>'control-label col-md-4'));?>
      <div class="col-md-8"> <?php echo form_input(array('name'=>'education[province]','class'=>'form-control'),set_value('education[province]',$education['province']));?> </div>
    </div>
    <div class="form-group">
    ...
    <div id="work_yes">
      ...
      <div class="form-group">
        ...
        <div class="col-md-8">
          <?php $g = array(''=>'เลือกรายการ','ยานยนต์และชิ้นส่วน'=>'ยานยนต์และชิ้นส่วน','เหล็กและเหล็กกล้า'=>'เหล็กและเหล็กกล้า','เฟอร์นิเจอร์'=>'เฟอร์นิเจอร์','อาหาร'=>'อาหาร','ซอฟต์แวร์'=>'ซอฟต์แวร์',
      ...
      <div class="form-group">
        ...
        <div class="col-md-8"> <?php echo form_input(array('name'=>'work_yes[position]','class'=>'form-control'),set_value('work_yes[position]',$work_yes['position']));?> </div>
      </div>
      <div class="form-group">
        <?php echo form_label('อายุงาน(ปี)','',array('class'=>'control-label col-md-4'));?>
        <div class="col-md-8"> <?php echo form_input(array('name'=>'work_yes[age]','class'=>'form-control'),set_value('work_yes[age]',$work_yes['age']));?> </div>
      </div>
      <div class="form-group">
        <?php echo form_label('ชื่อสถานที่ทำงาน','',array('class'=>'control-label col-md-4'));?>
        <div class="col-md-8"> <?php echo form_input(array('name'=>'work_yes[place]','class'=>'form-control'),set_value('work_yes[place]',$work_yes['place']));?> </div>
      </div>
      <div class="form-group">
        <?php echo form_label('ถนน','',array('class'=>'control-label col-md-4'));?>
        <div class="col-md-8"> <?php echo form_input(array('name'=>'work_yes[street]','class'=>'form-control'),set_value('work_yes[street]',$work_yes['street']));?> </div>
      </div>
      <div class="form-group">
        <?php echo form_label('ตำบล','',array('class'=>'control-label col-md-4'));?>
        <div class="col-md-8"> <?php echo form_input(array('name'=>'work_yes[tambon]','class'=>'form-control'),set_value('work_yes[tambon]',$work_yes['tambon']));?> </div>
      </div>
      <div class="form-group">
        <?php echo form_label('อำเภอ','',array('class'=>'control-label col-md-4'));?>
        <div class="col-md-8"> <?php echo form_input(array('name'=>'work_yes[amphur]','class'=>'form-control'),set_value('work_yes[amphur]',$work_yes['amphur']));?> </div>
      </div>
      <div class="form-group">
        <?php echo form_label('จังหวัด','',array('class'=>'control-label col-md-4'));?>
        <div class="col-md-8"> <?php echo form_input(array('name'=>'work_yes[province]','class'=>'form-control'),set_value('work_yes[province]',$work_yes['province']));?> </div>
      </div>
      <div class="form-group">
        <?php echo form_label('รหัสไปรษณีย์','',array('class'=>'control-label col-md-4'));?>
        <div class="col-md-8"> <?php echo form_input(array('name'=>'work_yes[zip]','class'=>'form-control zip'),set_value('work_yes[zip]',$work_yes['zip']));?> </div>
      </div>
      <div class="form-group">
    ...
    <div id="local">
      <div class="form-group">
        <?php echo form_label('ตำแหน่ง/อาชีพ','need_work_position',array('class'=>'control-label col-md-4'));?>
        <div class="col-md-8"> <?php echo form_input(array('name'=>'need_work_position','class'=>'form-control'),set_value('need_work_position',$standard['need_work_position'])); ?> </div>
      </div>
      <div class="form-group">
    ...
    <div id="abroad">
      <div class="form-group">
        ...
        <div class="col-md-8"> <?php echo form_input(array('name'=>'need_work_country','class'=>'form-control'),set_value('need_work_country',$standard['need_work_country'])); ?> <p class="help-block">*ให้เลือกกรณีจัดหางานในต่างประเทศ</p> </div> </div>
    </div>
    <hr>
    <div id="ctg_ctn">
      <div class="form-group">
        <?php echo form_label('ชื่อบริษัทจัดหางาน/สถานที่ทำงาน','',array('class'=>'control-label col-md-4'));?>
        <div class="col-md-8"> <?php echo form_input(array('name'=>'work_abroad[agent]','class'=>'form-control'),set_value('work_abroad[agent]',$work_abroad['agent']));?> <p class="help-block">*กรณีทดสอบฝีมือแรงงานเพื่อไปทำงานในต่างประเทศ</p> </div>
      </div>
      <div class="form-group">
        <?php echo form_label('ชื่อบริษัทนายจ้าง','',array('class'=>'control-label col-md-4'));?>
        <div class="col-md-8"> <?php echo form_input(array('name'=>'work_abroad[company]','class'=>'form-control'),set_value('work_abroad[company]',$work_abroad['company']));?> </div>
      </div>
      <div class="form-group">
        <?php echo form_label('เลขที่/หมู่ที่/ชื่อหน่วยงาน','',array('class'=>'control-label col-md-4'));?>
        <div class="col-md-8"> <?php echo form_input(array('name'=>'work_abroad[address]','class'=>'form-control'),set_value('work_abroad[address]',$work_abroad['address']));?> </div>
      </div>
      <div class="form-group">
        <?php echo form_label('ถนน','',array('class'=>'control-label col-md-4'));?>
        <div class="col-md-8"> <?php echo form_input(array('name'=>'work_abroad[street]','class'=>'form-control'),set_value('work_abroad[street]',$work_abroad['street']));?> </div>
      </div>
      <div class="form-group">
        <?php echo form_label('ตำบล','',array('class'=>'control-label col-md-4'));?>
        <div class="col-md-8"> <?php echo form_input(array('name'=>'work_abroad[tambon]','class'=>'form-control'),set_value('work_abroad[tambon]',$work_abroad['tambon']));?> </div>
      </div>
      <div class="form-group">
        <?php echo form_label('อำเภอ','',array('class'=>'control-label col-md-4'));?>
        <div class="col-md-8"> <?php echo form_input(array('name'=>'work_abroad[amphur]','class'=>'form-control'),set_value('work_abroad[amphur]',$work_abroad['amphur']));?> </div>
      </div>
      <div class="form-group">
        <?php echo form_label('จังหวัด','',array('class'=>'control-label col-md-4'));?>
        <div class="col-md-8"> <?php echo form_input(array('name'=>'work_abroad[province]','class'=>'form-control'),set_value('work_abroad[province]',$work_abroad['province']));?> </div>
      </div>
      <div class="form-group">
        <?php echo form_label('รหัสไปรษณีย์','',array('class'=>'control-label col-md-4'));?>
        <div class="col-md-8"> <?php echo form_input(array('name'=>'work_abroad[zip]','class'=>'form-control zip'),set_value('work_abroad[zip]',$work_abroad['zip']));?> </div>
      </div>
      <div class="form-group">
        <?php echo form_label('เบอร์โทรศัพท์','',array('class'=>'control-label col-md-4'));?>
        <div class="col-md-8"> <?php echo form_input(array('name'=>'work_abroad[phone]','class'=>'form-control tel'),set_value('work_abroad[phone]',$work_abroad['phone']));?> </div>
      </div>
      <div class="form-group">
        <?php echo form_label('ประเทศที่จะไปทำงาน','',array('class'=>'control-label col-md-4'));?>
        <div class="col-md-8"> <?php echo form_input(array('name'=>'work_abroad[country]','class'=>'form-control'),set_value('work_abroad[country]',$work_abroad['country'])); ?> </div>
      </div>
      <div class="form-group">
        <?php echo form_label('ระยะเวลาจ้าง','',array('class'=>'control-label col-md-4'));?>
        <div class="col-md-8"> <?php echo form_input(array('name'=>'work_abroad[duration]','class'=>'form-control','id'=>'duration','maxlength'=>'2'),set_value('work_abroad[duration]',$work_abroad['duration']));?> </div>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-md-8">
        <div class="checkbox"> <label><?=form_checkbox(array('name'=>'reference[refer]'),'สำเนาวุฒิการศึกษาหรือหนังสือรับรองการทำงาน',set_checkbox('refer','สำเนาวุฒิการศึกษาหรือหนังสือรับรองการทำงาน',($reference['refer'])));?>สำเนาวุฒิการศึกษาหรือหนังสือรับรองการทำงาน</label> </div>
        <div class="checkbox"> <label><?=form_checkbox(array('name'=>'reference[copy]'),'สำเนาบัตรประจำตัวประชาชนหรือสำเนาทะเบียนบ้าน',set_checkbox('copy','สำเนาบัตรประจำตัวประชาชนหรือสำเนาทะเบียนบ้าน',($reference['copy'])));?>สำเนาบัตรประจำตัวประชาชนหรือสำเนาทะเบียนบ้าน</label> </div>
    ...
    <div class="form-group">
      ...
      <div class="col-md-8">
        <div class="checkbox"> <label><?=form_checkbox(array('name'=>'allow'),TRUE);?></label> </div>
