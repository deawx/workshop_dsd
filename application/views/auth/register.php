      ...
      <div class="panel panel-success">
        ...
        <div class="panel-body">
          ...
          <?php if ($identity_column!=='email') : ?>
            <div class="form-group"> <?php echo lang('create_user_identity_label', 'identity',array('class'=>'control-label col-md-4')); ?>
              <?php echo form_error('identity'); ?>
            </div>
            <div class="col-md-8"> <?php echo form_input($identity,'',array('class'=>'form-control')); ?> </div>
          <?php endif; ?>
          <div class="form-group"> <?php echo lang('create_user_email_label', 'email',array('class'=>'control-label col-md-4'));?>
            <div class="col-md-8"> <?php echo form_input($email,'',array('class'=>'form-control'));?> </div>
          </div>
