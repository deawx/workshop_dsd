    ...
    <div class="col-sm-6 col-sm-offset-3">
      <div class="panel panel-success">
        ...
        <div class="panel-body">
          ...
          <div class="form-group">
            <?php echo lang('login_password_label', 'password',array('class'=>'control-label col-md-4'));?>
            <div class="col-md-8">
              <?php echo form_input($password,'',array('class'=>'form-control'));?>
            </div>
          </div>
          <div class="form-group">
            <?php echo lang('login_remember_label', 'remember',array('class'=>'control-label col-md-4'));?>
            <div class="col-md-8">
              <div class="checkbox">
                <label> <?php echo form_checkbox('remember', '1', FALSE,array('id'=>'remember'));?> </label>
              </div>
            </div>
          </div>
          <div class="form-group">
